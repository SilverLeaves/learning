...
//类似于koa的框架，需要和http模块、https模块一起使用
var connect = require('connect');


//对serve-static和serve-index的引用
//用serve-static将serve-index包装
...
app.use(serveStatic(argv.dir+"\\test", { 'index': ['index.html'] }));

app.use(serveIndex(argv.dir+"\\test", { 'icons': true }));

console.log(argv.dir+"\\test")
